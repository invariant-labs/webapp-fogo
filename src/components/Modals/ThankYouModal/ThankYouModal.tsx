...
import { circleDiscordIcon, circleTelegramIcon, fogoIcon } from '@static/icons'
    ...
    <>
      ...
      <Box className={classes.container}>
        <Box className={classes.gradient}>
          <img className={classes.fogoIcon} src={fogoIcon} alt='Fogo icon' />
          ...
          <Box className={classes.subheaderWrapper}>
            ...
            <Typography className={classes.lowerTitle}>
              for using Invariant Faucet on Fogo!
            </Typography>
          </Box>
          <Typography className={classes.description}>
            We are building much more on Fogo right now! 👀 <br />
